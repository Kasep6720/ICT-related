...
def sub3():
    ...
    # pls ignore
    LeChosenChild = input("Specific Word: ")
    print()
    LilLeChosenChild = LeChosenChild.lower()
...
def sub4():
    ...
    SomeExceptions = maintext.count('Dr.')+maintext.count('Esq.')+maintext.count('Hon.')+maintext.count('Jr.')+maintext.count('Mr.')+maintext.count('Mrs.')+maintext.count('Ms.')+maintext.count('Messrs.')+maintext.count('Mmes.')+maintext.count('Msgr.')+maintext.count('Prof.')+maintext.count('Rev.')+maintext.count('Rt. Hon.')+maintext.count('Sr.')+maintext.count('St.')
    print('Total number of sentences:',int(OrgSentence - SomeExceptions))
