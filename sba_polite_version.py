...
def sub5():
    ...
    for i in range(len(LeFunctionWords)): #Guess its obvious I don't need to explain.
        if dd.count(LeFunctionWords[i]) >= 1:
            print(LeFunctionWords[i],dd.count(LeFunctionWords[i]))
    input()
