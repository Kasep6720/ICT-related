...
def sub5():
    ...
    for i in range(len(stupidassmffunctionwords)): #Guess its obvious I don't need to explain.
        if dd.count(stupidassmffunctionwords[i]) >= 1:
            print(stupidassmffunctionwords[i],dd.count(stupidassmffunctionwords[i]))
    input()
